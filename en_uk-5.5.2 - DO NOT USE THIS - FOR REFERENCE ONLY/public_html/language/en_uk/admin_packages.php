...
$lang['AdminPackages.groups.heading_parent_groups'] = "Parent Categories";
...
$lang['AdminPackages.!tooltip.prorata'] = "Pro rata allows a specific set of the month to be set for the renewal of services created with this package. Only monthly and yearly periods will be affected by this option.";
