...
$lang['AdminClients.add.field_country'] = "Company/Org.";
...
$lang['AdminClients.addachaccount.field_accountsubmit'] = "v";
...
$lang['AdminClients.createinvoice.boxtitle_createinvoice'] = "Create an Invoice";
...
$lang['AdminClients.accountcontactinfo.field_state'] = "County";
...
$lang['AdminClients.services.category_canceled'] = "Cancelled";
...
$lang['AdminClients.addachaccount.page_title'] = "Create Account"; // %1$s is the client ID number
...
$lang['AdminClients.addcontact.page_title'] = "Client number:%1\$s New Contact"; // %1$s is the client ID number
...
$lang['AdminClients.addservice.page_title'] = "
...
$lang['AdminClients.services.heading_datecanceled'] = "Date Cancelled";
...
$lang['AdminClients.addservice.term_dated'] = "%1\$s is the pricing term, %2\$s is the pricing period, %3\$s is the formatted price, %4\$s is the start date of the service, %5\$s is the end date of the service"; // %1$s is the pricing term, %2$s is the pricing period, %3$s is the formatted price, %4$s is the start date of the service, %5$s is the end date of the service
...
"; // %1$s is the pricing term, %2$s is the pricing period, and %3$s is the formatted price
$lang['AdminClients.addservice.term'] = "
...
$lang['AdminClients.!notice.queued_service_change'] = "This service has changes pending. Updating this service to upgrade or downgrade any of its values will cause the current pending changes to be cancelled.";
$lang['AdminClients.accounts.type_cc'] = "%2\$s %1\$s, Expires %3\$s"; // %1$s is the account type (Credit Card) and %2$s is the type of account (MasterCard, Visa, etc.), %3$s is the formatted card expiration date
...
$lang['AdminClients.!success.services_scheduled_cancel'] = "The selected services were successfully scheduled to be cancelled.";
$lang['AdminClients.!success.services_scheduled_uncancel'] = "The selected services are no longer scheduled to be cancelled.";
