...
$lang['AdminTickets.!notice.no_departments_staff'] = "No staff and/or departments have been created yet. Click %1\$s above to create a department, or %2\$s to assign a staff member."; // %1$s is the language definition for the Departments navigation item, %2$s is the language definition for the Staff navigation item
...
$lang['AdminTickets.reply.reply_date'] = "Invoice Search"; // %1$s is the ticket reply date, %2$s is the first name of the reply author, %3$s is the last name of the reply author
