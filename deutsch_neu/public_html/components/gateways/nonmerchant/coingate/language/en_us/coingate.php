...
// Error
$lang['Coingate.!error.app_id.empty'] = 'APP ID can not be empty.';
$lang['Coingate.!error.api_key.empty'] = 'API Key can not be empty';
$lang['Coingate.!error.api_secret.empty'] = 'API Secret can not be empty';
