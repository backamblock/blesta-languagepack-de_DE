...
$lang['Automation.task.cleanup_logs.logs_messenger_deleted'] = "%1\$s alte Messenger-Logs wurden gelöscht."; // %1$s is the number of logs deleted"; //en: "'%1$s old Messenger logs have been deleted.'; // %1$s is the number of logs deleted"
...
$lang['Automation.task.cleanup_logs.logs_cron_deleted'] = "%1\$s alte Cron-Logs wurden gelöscht."; // %1$s is the number of logs deleted"; //en: "'%1$s old Cron logs have been deleted.'; // %1$s is the number of logs deleted"
