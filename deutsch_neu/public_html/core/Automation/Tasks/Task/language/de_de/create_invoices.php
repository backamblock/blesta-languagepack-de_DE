...
$lang['Automation.task.create_invoices.recurring_invoice_success'] = "Erfolgreich eine neue Rechnung aus der wiederkehrenden Rechnung #%1\$s für den Kunden #%2\$s erstellt."; // %1$s is the recurring invoice number, %2$s is the client ID"; //en: "'Successfully created a new invoice from recurring invoice #%1$s for client #%2$s.'; // %1$s is the recurring invoice number, %2$s is the client ID"
