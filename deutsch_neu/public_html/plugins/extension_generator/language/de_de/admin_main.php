...
// Notice messages
$lang['AdminMain.!notice.type_warning'] = "Wenn Sie den Erweiterungstyp ändern, werden alle für diese Erweiterung gespeicherten Einstellungen unwiderruflich gelöscht."; //en: "'Changing the extension type will irrevirsibly erase all settings saved for this extension.'"
...
$lang['AdminMain.!success.plugin_created'] = "Das neue Plugin wurde erfolgreich erstellt und befindet sich unter %1\$s"; // Where %1$s is the path to the created plugin's directory"; //en: "'The new plugin has been successfully generated and can be found at %1$s'; // Where %1$s is the path to the created plugin's directory"
...
$lang['AdminMain.getfilelocations.custom'] = "Benutzerdefiniert"; //en: "'Custom'"
...
$lang['AdminMain.index.extension_add'] = "Zusatz Addon"; //en: "'Add Extension'"
...
$lang['AdminMain.index.heading_code_examples'] = "Codebeispiele"; //en: "'Code Examples'"
$lang['AdminMain.index.heading_date_updated'] = 'Date Updated';
$lang['AdminMain.index.heading_options'] = "Optionen"; //en: "'Options'"

$lang['AdminMain.index.option_edit'] = "Bearbeiten"; //en: "'Edit'"
...
$lang['AdminMain.general.code_examples'] = "Beispielcode einfügen"; //en: "'Include Example Code'"
...
$lang['AdminMain.confirm.custom_path'] = "Benutzerdefinierter Pfad"; //en: "'Custom Path'"
