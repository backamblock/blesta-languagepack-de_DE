...
$lang['AdminModule.getoptionalfunctions.tooltip_unsuspendService'] = "Wird aufgerufen, um Modulaktionen bei der Aussetzung des Dienstes durchzuführen."; //en: "'Called to perform module actions on service unsuspension.'"
...
$lang['AdminModule.getoptionalfunctions.tooltip_editPackage'] = "Führt alle erforderlichen Aktionen aus, um das Paket auf dem Remote-Server zu bearbeiten. Setzt Eingabefehler bei Fehler, wodurch das Paket nicht bearbeitet werden kann."; //en: "'Performs any action required to edit the package on the remote server. Sets Input errors on failure, preventing the package from being edited.'"
...
$lang['AdminModule.getoptionalfunctions.tooltip_upgrade'] = "Führt die Migration der Daten von \$current_version (der aktuell installierten Version) auf das angegebene Dateisystem durch. Setzt bei einem Fehlschlag Eingabefehler, so dass das Modul nicht aktualisiert werden kann."; //en: "'Performs migration of data from $current_version (the current installed version) to the given file set version. Sets Input errors on failure, preventing the module from being upgraded.'"
...
$lang['AdminModule.getoptionalfunctions.tooltip_selectModuleRow'] = "Legt fest, welche Modulreihe versucht werden soll, wenn ein Dienst für die angegebene Gruppe bereitgestellt wird, basierend auf der für diese Gruppe festgelegten Bestellmethode."; //en: "'Determines which module row should be attempted when a service is provisioned for the given group based upon the order method set for that group.'"
...
$lang['AdminModule.getoptionalfunctions.tooltip_getDomainIsLocked'] = "Gibt zurück, ob die Domain gesperrt ist oder nicht, gibt \"boolean\" zurück."; //en: "'Returns whether or not the domain is locked, returns boolean.'"
...
$lang['AdminModule.getoptionalfunctions.tooltip_setNameserverIps'] = "Legt die Nameserver für einen bestimmten Domainnamen fest."; //en: "'Sets the name servers for a given domain name.'"
...
$lang['AdminModule.getoptionalfunctions.tooltip_setDomainContacts'] = "Aktualisiert die Liste der mit einer Domain verbundenen Kontakte."; //en: "'Updates the list of contacts associated with a domain.'"
...
$lang['AdminModule.basic.author_name'] = "Autorenname"; //en: "'Author Name'"
$lang['AdminModule.basic.author_url'] = "Autoren-URL"; //en: "'Author URL'"
$lang['AdminModule.basic.text_options'] = 'Options';
$lang['AdminModule.basic.author_row_add'] = "Autor hinzufügen"; //en: "'Add Author'"
$lang['AdminModule.basic.text_remove'] = 'Remove';
$lang['AdminModule.basic.static_tlds'] = "Statische Definition von TLDs"; //en: "'Statically Define TLDs'"
$lang['AdminModule.basic.tlds'] = 'TLDs';
$lang['AdminModule.basic.placeholder_tlds'] = ".com, .net, .org"; //en: "'.com,.net,.org'"
...
// Fields page
$lang['AdminModule.fields.heading_module_row_fields'] = "Modul Zeilenfelder"; //en: "'Module Row Fields'"
...
$lang['AdminModule.fields.name_key'] = "Namensschlüssel"; //en: "'Name Key'"

$lang['AdminModule.fields.tooltip_name'] = 'The name of the field in the code base';
$lang['AdminModule.fields.tooltip_label'] = "Der Anzeigename des Feldes"; //en: "'The display name of the field'"
...
$lang['AdminModule.fields.placeholder_package_name'] = "z.B. package_field"; //en: "'e.g. package_field'"
...
$lang['AdminModule.fields.package_row_add'] = "Paketfeld hinzufügen"; //en: "'Add Package Field'"
$lang['AdminModule.fields.service_row_add'] = 'Add Service Field';

$lang['AdminModule.fields.text_options'] = 'Options';
$lang['AdminModule.fields.text_remove'] = "Entfernen"; //en: "'Remove'"

$lang['AdminModule.fields.features'] = "Weiter - Zusätzliche Funktionen"; //en: "'Next - Additional Features'"

$lang['AdminModule.fields.package_fields_epp_code_label'] = "EPP Code"; //en: "'EPP Code'"
...
$lang['AdminModule.features.level'] = "Level"; //en: "'Level'"
$lang['AdminModule.features.name'] = "Name"; //en: "'Name'"
...
$lang['AdminModule.features.tooltip_cron_label'] = "Angezeigter Name der Cron-Aufgabe"; //en: "'The display name of the cron task'"
$lang['AdminModule.features.tooltip_description'] = 'The description shown on the cron task list page';
$lang['AdminModule.features.tooltip_type'] = "Die Art der Zeitsteuerung, die für die Cron-Aufgabe verwendet werden soll (Zeit oder Intervall)"; //en: "'The type of timing to use for the cron task (time or interval)'"
$lang['AdminModule.features.tooltip_time'] = "Die tägliche 24-Stunden-Zeit, zu der diese Aufgabe ausgeführt werden soll (z. B. \"14:25\") ODER Das Intervall in Minuten, in dem diese Cron-Aufgabe ausgeführt werden soll"; //en: "'The daily 24-hour time that this task should run (e.g. "14:25") OR The interval, in minutes, that this cron task should run'"

$lang['AdminModule.features.placeholder_method_name'] = 'e.g. tabChangePassword';
$lang['AdminModule.features.placeholder_tab_label'] = "z.B. Passwort ändern"; //en: "'e.g. Change Password'"
...
$lang['AdminModule.features.service_tab_row_add'] = "Registerkarte Service Management hinzufügen"; //en: "'Add Service Management Tab'"
$lang['AdminModule.features.cron_task_row_add'] = 'Add Cron Task';

$lang['AdminModule.features.text_options'] = "Optionen"; //en: "'Options'"
