...
$lang['AdminPlugin.getactionlocations.widget_staff_billing'] = "Widget - Rechnungsübersicht (Mitarbeiter)"; //en: "'Widget - Billing Overview (Staff)'"

$lang['AdminPlugin.getcardlevels.client'] = 'Client';
$lang['AdminPlugin.getcardlevels.staff'] = 'Staff';

$lang['AdminPlugin.getoptionalfunctions.tooltip_upgrade'] = "Führt die Migration der Daten von \$current_version (der aktuell installierten Version) auf die angegeben Datensatz durch. Setzt bei einem Fehlschlag Eingabefehler, so dass das Modul nicht aktualisiert werden kann."; //en: "'Performs migration of data from $current_version (the current installed version) to the given file set version. Sets Input errors on failure, preventing the module from being upgraded.'"
...
$lang['AdminPlugin.basic.heading_authors'] = "Autoren"; //en: "'Authors'"

$lang['AdminPlugin.basic.description'] = 'Description';
$lang['AdminPlugin.basic.logo'] = "Logo"; //en: "'Logo'"
$lang['AdminPlugin.basic.author_name'] = "Autor Name"; //en: "'Author Name'"
$lang['AdminPlugin.basic.author_url'] = "Autor-URL"; //en: "'Author URL'"
$lang['AdminPlugin.basic.text_options'] = 'Options';
$lang['AdminPlugin.basic.author_row_add'] = "Autor hinzufügen"; //en: "'Add Author'"
...
$lang['AdminPlugin.basic.placeholder_author_name'] = "z.B. Blesta"; //en: "'e.g. Blesta'"
...
// Database info page
$lang['AdminPlugin.database.heading_database'] = "Datenbank Tabellen"; //en: "'Database Tables'"
$lang['AdminPlugin.database.heading_more_info'] = "Mehr Infos"; //en: "'More Info'"
...
$lang['AdminPlugin.database.tooltip_table_name'] = "Der Name der Datenbank Tabelle (z.B. extention_table_name)"; //en: "'The name of the table in the database (e.g. extention_table_name)'"
$lang['AdminPlugin.database.placeholder_table_name'] = "z. B. extention_table_name"; //en: "'e.g. extention_table_name'"

$lang['AdminPlugin.database.column_name'] = "Spalte Name"; //en: "'Column Name'"
...
$lang['AdminPlugin.database.tooltip_length'] = "Legt die maximale Anzahl von Zeichen in einem Feld fest. Wenn der Spaltentyp \"enum\" ist, geben Sie die Werte bitte in diesem Format ein: 'a','b','c'..."; //en: "'Sets the max number of characters in a field. If column type is "enum", please enter the values using this format: \'a\',\'b\',\'c\'...'"
...
$lang['AdminPlugin.database.tooltip_nullable'] = "Ob ein Nullwert für diese Spalte zulässig sein soll oder nicht."; //en: "'Whether or not to allow a null value for this column.'"
...
$lang['AdminPlugin.database.text_options'] = "Optionen"; //en: "'Options'"
...
$lang['AdminPlugin.integrations.name'] = "Name"; //en: "'Name'"
...
$lang['AdminPlugin.integrations.text_options'] = "Optionen"; //en: "'Options'"
...
$lang['AdminPlugin.integrations.placeholder_controller'] = "z. B. admin_main"; //en: "'e.g. admin_main'"
...
$lang['AdminPlugin.integrations.placeholder_event_callback'] = "z.B. myClientAddHandlerMethod"; //en: "'e.g. myClientAddHandlerMethod'"
...
$lang['AdminPlugin.integrations.features'] = "Weiter - Zusätzliche Funktionen"; //en: "'Next - Additional Features'"
...
$lang['AdminPlugin.features.tooltip_type'] = "Die Art der Zeitsteuerung, die für die Cron-Aufgabe verwendet werden soll (Zeit oder Intervall)"; //en: "'The type of timing to use for the cron task (time or interval)'"
$lang['AdminPlugin.features.tooltip_time'] = "Dieser Crontask sollte ausgeführt werden"; //en: "'The daily 24-hour time that this task should run (e.g. "14:25") OR The interval, in minutes, that this cron task should run'"

$lang['AdminPlugin.features.placeholder_method_name'] = 'e.g. tabChangePassword';
$lang['AdminPlugin.features.placeholder_tab_label'] = "z.B. Passwort ändern"; //en: "'e.g. Change Password'"
...
$lang['AdminPlugin.features.text_options'] = "Optionen"; //en: "'Options'"
$lang['AdminPlugin.features.text_remove'] = "Entfernen"; //en: "'Remove'"
