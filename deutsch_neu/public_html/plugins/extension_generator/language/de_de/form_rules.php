...
$lang['FormRules.modulebasic.authors[][name].empty'] = "Bitte geben Sie für jeden Autor einen Namen an."; //en: "'Please enter a name for each author.'"
...
$lang['FormRules.modulefields.module_rows[][label].empty'] = "Bitte geben Sie für jedes Modulzeilenfeld eine Beschriftung ein."; //en: "'Please enter a label for each module row field.'"
$lang['FormRules.modulefields.module_rows[][type].valid'] = "Eine oder mehrere Modulzeilen haben einen ungültigen Typ."; //en: "'One or more module rows has an invalid type.'"
...
$lang['FormRules.modulefields.service_fields[][name_key].valid'] = "Ob ein Servicefeld als Namensschlüssel gesetzt werden soll, muss auf true oder false gesetzt werden."; //en: "'Whether to set a service field as the name key must be set to true or false.'"
...
$lang['FormRules.modulefeatures.cron_tasks[][label].empty'] = "Bitte geben Sie für jede Cron-Aufgabe eine Beschreibung ein."; //en: "'Please enter a label for each cron task.'"
...
$lang['FormRules.pluginintegrations.actions[][action].format'] = "Bitte geben Sie für jede Aktion eine Aktion in Kleinbuchstaben an."; //en: "'Please enter an action for each action in all lower-case letters.'"
...
$lang['FormRules.pluginintegrations.cards[][label].empty'] = "Bitte geben Sie für jede Karte ein Label ein."; //en: "'Please enter a label for each card.'"
...
$lang['FormRules.nonmerchantbasic.currencies.format'] = "Bitte geben Sie die Währungen im Drei-Zeichen-Format und durch Komma getrennt ein (z.B. USD,EUR,JPY)."; //en: "'Please enter currencies in three character format separated by commas (e.g. USD,EUR,JPY).'"


// Merchant fields
$lang['FormRules.nonmerchantfields.fields[][name].format'] = 'Please enter a name for each field in the format snake_case_name.';
$lang['FormRules.nonmerchantfields.fields[][label].empty'] = "Bitte geben Sie für jedes Feld eine Bezeichnung (Label) ein."; //en: "'Please enter a label for each field.'"
