<?php
/**
 * de_de language for the Domain Manager plugin.
 */
// Basics
...
$lang['DomainsPlugin.getCronTasks.domain_synchronization_description'] = "Synchronisieren Sie die Domain-Dienste mit dem Ablaufdatum ihres Registrar-Moduls"; //en: "'Synchronize domain services with the expiry date from their registrar module'"
...
$lang['DomainsPlugin.getCronTasks.domain_renewal_reminders_description'] = "Senden Sie E-Mail-Erinnerungen für Domains, deren Verlängerungsdatum näher rückt"; //en: "'Send email reminders for domains that are drawing close to their expiration date'"

// Plugin Actions
$lang['DomainsPlugin.nav_secondary_staff.domain_options'] = "Domain Optionen"; //en: "'Domain Options'"
$lang['DomainsPlugin.nav_secondary_staff.domains'] = 'Domains';

$lang['DomainsPlugin.nav_client.services'] = "Dienstleistungen"; //en: "'Services'"
$lang['DomainsPlugin.nav_client.domains'] = 'Domains';

// Plugin Cards
$lang['DomainsPlugin.card_client.getDomainCount'] = "Domains"; //en: "'Domains'"
...
$lang['DomainsPlugin.email_forwarding.description'] = "E-Mail-Weiterleitung"; //en: "'Email Forwarding'"
$lang['DomainsPlugin.dns_management.name'] = "DNS-Verwaltung"; //en: "'DNS Management'"
...
$lang['DomainsPlugin.upgrade.domains_id_protection_option_group'] = "Alle Domain-Namen müssen gemäß den ICANN-Regeln über gültige Kontaktinformationen verfügen. Mit dieser Option werden diese Angaben vor dem öffentlichen Whois verborgen, so dass Ihre Informationen privat bleiben."; //en: "'All domain names must have valid contact information as part of ICANN rules. This option will hide these details from the public whois, keeping your information private.'"
