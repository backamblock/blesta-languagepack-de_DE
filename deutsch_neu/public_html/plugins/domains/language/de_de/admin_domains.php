...
$lang['AdminDomains.!success.tld_added'] = "Die TLD wurde erfolgreich hinzugefügt!"; //en: "'The TLD was successfully added!'"
...
$lang['AdminDomains.!success.change_status'] = "TLD-Zustände wurden erfolgreich aktualisiert!"; //en: "'The TLD statuses were successfully updated!'"
...
$lang['AdminDomains.!success.tlds_imported'] = "Die TLDs sind erfolgreich importiert worden!"; //en: "'The TLDs were successfully imported!'"
...
$lang['AdminDomains.browse.page_title'] = "Domains > Durchsuchen"; //en: "'Domains > Browse'"
...
$lang['AdminDomains.browse.heading_registration'] = "Datum der Registrierung"; //en: "'Registration Date'"
$lang['AdminDomains.browse.heading_renewal'] = "Verlängerungsdatum"; //en: "'Renewal Date'"
...
$lang['AdminDomains.browse.confirm_delete'] = "Sind Sie sicher, dass Sie diesen Domain Dienst löschen wollen?"; //en: "'Are you sure you want to delete this domain service?'"
...
$lang['AdminDomains.browse.category_suspended'] = "Ausgesetzt"; //en: "'Suspended'"
...
$lang['AdminDomains.browse.tooltip_renew'] = "Automatische Erneuerung für Blesta bedeutet, dass dem Nutzer automatisch eine Rechnung gestellt wird und die Domain erneuert wird, sobald die Rechnung bezahlt ist."; //en: "'Auto Renewal for Blesta means that the user will be invoiced automatically and that the domain will be renewed once the invoice is paid.'"
...
$lang['AdminDomains.configuration.tab_notifications'] = "Benachrichtigungen"; //en: "'Notifications'"
...
$lang['AdminDomains.configuration.tab_configurableoptions'] = "Konfigurierbare Optionen"; //en: "'Configurable Options'"
...
$lang['AdminDomains.configuration.field_second_reminder_days_before'] = "2nd Erneuerungs Benachrichtigung tage zuvor"; //en: "'2nd Expiration Reminder Days Before'"
...
$lang['AdminDomains.configuration.tooltip_dns_management_option_group'] = "Die konfigurierbare Optionsgruppe, mit der gesteuert wird, ob eine Domain über DNS-Verwaltungsdienste verfügen soll."; //en: "'The configurable option group used to control whether a domain will have DNS management services.'"
...
$lang['AdminDomains.configuration.tooltip_first_reminder_days_before'] = "Wähle die Anzahl an Tagen bevor eine Domain ausläuft um die erste Erneuerungsmail zu senden (26-35 per ICANN Standart). Nutze den E-Mail Template link um die Datei zu bearbeiten/deactivieren zu können."; //en: "'Select the number of days before a domain expires to send the first reminder email (26-35 as per ICANN specs). Use the Email Template link to modify/disable this email.'"
...
$lang['AdminDomains.configuration.tooltip_renewal_days_before_expiration'] = "Wenn Domains in Rechnung gestellt werden, wird die Rechnung diese Anzahl von Tagen vor dem Ablaufdatum der Domain fällig."; //en: "'When domains are invoiced, the invoice will be due this number of days prior to the domain\'s expiration date.'"
...
$lang['AdminDomains.importpackages.tooltip_migrate_services'] = "Wenn diese Option aktiviert ist, werden alle Leistungen, die den geklonten Paketen zugeordnet sind, auf die neu erstellten Pakete übertragen. Dies gilt nur für Leistungen mit einer jährlichen Preisperiode."; //en: "'When checked, any services assigned to the cloned packages will be migrated to the newly created packages.  This will only apply to services with a yearly pricing period.'"
$lang['AdminDomains.importpackages.field_overwrite_packages'] = "TLD-Pakete überschreiben"; //en: "'Overwrite TLD Packages'"
...
$lang['AdminDomains.importpackages.field_submit'] = "Pakete importieren"; //en: "'Import Packages'"
...
$lang['AdminDomains.configurableoptions.heading_configurable_option'] = "Konfigurierbare Optionen"; //en: "'Configurable Option'"
$lang['AdminDomains.configurableoptions.heading_options'] = 'Options';
$lang['AdminDomains.configurableoptions.option_edit'] = 'Edit';


$lang['AdminDomains.configurableoptions_pricing.boxtitle_edit_configurable_option'] = "Bearbeiten von %1\$s"; //en: "'Edit %1$s'"
...
$lang['AdminDomains.tlds.heading_email_forwarding'] = "E-Mail-Weiterleitung"; //en: "'Email Forwarding'"
$lang['AdminDomains.tlds.heading_id_protection'] = 'ID Protection';
$lang['AdminDomains.tlds.heading_epp_code'] = 'EPP Code';
$lang['AdminDomains.tlds.heading_module'] = "Modul"; //en: "'Module'"
...
$lang['AdminDomains.tlds.tooltip_id_protection'] = "Die Verfügbarkeit des ID-Schutzes hängt davon ab, ob das Registrierstellen-Modul diese Funktion implementiert, und ist möglicherweise nicht für alle TLDs oder Registrierstellen verfügbar."; //en: "'The availability of ID Protection will depend on whether the registrar module implements such functionality and may not be available for all TLDs or registrars'"
$lang['AdminDomains.tlds.tooltip_epp_code'] = "Die Verfügbarkeit des EPP-Codes hängt davon ab, ob das Registrierstellen-Modul diese Funktion implementiert und ist möglicherweise nicht für alle TLDs oder Registrierstellen verfügbar."; //en: "'The availability of the EPP Code will depend on whether the registrar module implements such functionality and may not be available for all TLDs or registrars'"


// Get TLD Actions
$lang['AdminDomains.getTldActions.option_change_status'] = 'Change Status';
$lang['AdminDomains.getTldActions.option_tld_sync'] = "Registrar Price Sync"; //en: "'Registrar Price Sync'"
...
$lang['AdminDomains.pricing.tab_nameservers'] = "Nameserver"; //en: "'Name Servers'"
$lang['AdminDomains.pricing.tab_welcome_email'] = 'Welcome Email';
$lang['AdminDomains.pricing.tab_advanced'] = 'Advanced';
$lang['AdminDomains.pricing.heading_term'] = "Bezeichnung"; //en: "'Term'"
...
$lang['AdminDomains.pricing.text_advanced_options'] = "Bearbeiten Sie das Kernpaket, um Kundenlimits, konfigurierbare Optionen, verfügbare Mengen, Plugin-Integrationen, Beschreibungen und mehr zu definieren."; //en: "'Edit the core package, to define Client Limits, Configurable Options, Available Quantity, Plugin Integrations, Descriptions and more.'"
$lang['AdminDomains.pricing.field_nameserver'] = 'Name Server %1$s'; // %1$s is the name server
$lang['AdminDomains.pricing.field_modulegroup_any'] = "Irgendeins"; //en: "'Any'"
...
$lang['AdminDomains.meta.field_continue'] = "Weiter"; //en: "'Continue'"
...
$lang['AdminDomains.import.title_terms'] = "Bedingungen"; //en: "'Terms'"
$lang['AdminDomains.import.title_tlds'] = "TLDs"; //en: "'TLDs'"
...
$lang['AdminDomains.import.text_years'] = "%1\$s Jahre"; // %1$s is the number of years"; //en: "'%1$s Years'; // %1$s is the number of years"
$lang['AdminDomains.import.text_terms_notice'] = 'At least one term must be selected.';


$lang['AdminDomains.getDays.same_day'] = 'Same Day';
$lang['AdminDomains.getDays.text_day'] = "%1\$s Tag"; // %1$s is the number of days"; //en: "'%1$s Day'; // %1$s is the number of days"
$lang['AdminDomains.getDays.text_days'] = "%1\$s Tage"; // %1$s is the number of days"; //en: "'%1$s Days'; // %1$s is the number of days"
...
$lang['AdminDomains.getOperators.earlier'] = "Früher"; //en: "'Earlier'"
