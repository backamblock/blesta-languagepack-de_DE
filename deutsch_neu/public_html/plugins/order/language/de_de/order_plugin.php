<?php
// Plugin details
$lang['OrderPlugin.name'] = "Bestellsystem"; //en: "Order System"

// Orders widget name
$lang['OrderPlugin.admin_main.name'] = "Aufträge"; //en: "Orders"

// Subtab names
$lang['OrderPlugin.admin_forms.name'] = "Bestellformulare"; //en: "Order Forms"
...
// Client links
$lang['OrderPlugin.client.name'] = "Auftrag"; //en: "Order"
$lang['OrderPlugin.client_affiliates.name'] = "Partner"; //en: "Affiliates"
...
// Cron task
$lang['OrderPlugin.cron.accept_paid_orders_name'] = "Anstehende Aufträge akzeptieren"; //en: "Accept Paid Pending Orders"
$lang['OrderPlugin.cron.accept_paid_orders_desc'] = "Akzeptiert automatisch bezahlte ausstehende Bestellungen, wenn dies im Bestellformular zulässig ist."; //en: "Automatically accepts paid pending orders if the order form allows it."
...
$lang['OrderPlugin.cron.process_abandoned_orders_desc'] = "Senden Sie Erinnerungs-E-Mails, führen Sie Stornierungen durch und deaktivieren Sie Kunden für abgebrochene Bestellungen"; //en: "'Send reminder emails, perform cancellations, and deactivate clients for abandoned orders'"
...
// Permissions
$lang['OrderPlugin.permission.admin_affiliates'] = "Partner"; //en: "'Affiliates'"
$lang['OrderPlugin.permission.admin_affiliates_add'] = 'Add Affiliate';
$lang['OrderPlugin.permission.admin_affiliates_update'] = "Partner aktualisieren"; //en: "'Update Affiliate'"
$lang['OrderPlugin.permission.admin_affiliates_activate'] = "Affiliate aktivieren"; //en: "'Activate Affiliate'"
$lang['OrderPlugin.permission.admin_affiliates_deactivate'] = 'Deactivate Affiliate';
$lang['OrderPlugin.permission.admin_affiliates_settings'] = "Partnereinstellungen"; //en: "'Affiliate Settings'"
$lang['OrderPlugin.permission.admin_payouts'] = 'Payouts';
$lang['OrderPlugin.permission.admin_payouts_edit'] = 'Edit Payout';
$lang['OrderPlugin.permission.admin_payouts_approve'] = "Auszahlung beantragen"; //en: "'Approve Payout'"
$lang['OrderPlugin.permission.admin_payouts_decline'] = "Auszahlung ablehnen"; //en: "'Decline Payout'"
$lang['OrderPlugin.permission.admin_payment_methods'] = "Zahlungsarten"; //en: "'Payment Methods'"
...
$lang['OrderPlugin.permission.admin_payment_methods_delete'] = "Zahlungsmethode löschen"; //en: "'Delete Payment Method'"
