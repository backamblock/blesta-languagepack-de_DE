...
$lang['AdminSettings.settings.field_order_frequency'] = "Bestellreienfolge"; //en: "'Order Frequency'"
$lang['AdminSettings.settings.tooltip_order_frequency'] = "Entweder um Empfehlungen nur für die erste Bestellung zu bezahlen, die ein Kunde über einen Empfehlungs-Link tätigt oder beliebig, um Empfehlungen für jede Bestellung zu bezahlen, die ein Kunde über einen Empfehlungs-Link tätigt."; //en: "'First to pay referrals only for the first order a client makes using a referral link, or Any to pay referrals for each order a client makes using a referral link.'"
...
$lang['AdminSettings.settings.tooltip_maturity_days'] = "Die Anzahl der Tage, die eine Überweisung fällig und für eine Auszahlung verfügbar wird."; //en: "'The number of days after payment a referral matures and becomes available for payout.'"
...
$lang['AdminSettings.settings.zero_amount'] = "Die Auszahlungshöhe ist aktuell bei null, bedeuted das Partner keine Auszahlung erhalten."; //en: "'The withdrawal amount is currently zero, meaning that affiliates will receive no funds from referrals'"
