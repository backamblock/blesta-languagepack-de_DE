<?php
$lang['Whmcs8_0.!error.host.invalid'] = "Datenbank-Host ist erforderlich."; //en: "Database Host is required."
$lang['Whmcs8_0.!error.database.invalid'] = "Datenbankname ist erforderlich."; //en: "Database Name is required."
$lang['Whmcs8_0.!error.user.invalid'] = "Database User is required.";
$lang['Whmcs8_0.!error.pass.invalid'] = "Datenbank Passwort wird benötigt!"; //en: "Database Password is required."
...
$lang['Whmcs8_0.!notice.gmp'] = "Die Erweiterung 'gmp' wurde nicht gefunden. Diese Erweiterung wird empfohlen, um die Leistung zu erhöhen und den Importprozess zu verbessern. Sie können auch ohne diese Erweiterung fortfahren, aber der Importvorgang kann sehr viel langsamer sein."; //en: "The 'gmp' extension was not found. This extension is recommended to improve performance and will improve the import process. You may continue without this extension but the import process may be much slower."

$lang['Whmcs8_0.settings.host'] = "Datenbankhost"; //en: "Database Host"
...
$lang['Whmcs8_0.settings.key'] = "CC-Verschlüsselung Hash"; //en: "CC Encryption Hash"
...
$lang['Whmcs8_0.configuration.remote_package'] = "Remote-Paket"; //en: "Remote Package"
