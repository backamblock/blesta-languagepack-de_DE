...
$lang['Checkout.!error.invalid_agree_tos'] = "Sie müssen Ihre Zustimmung zu den Allgemeinen Geschäftsbedingungen bestätigen.";
$lang['Checkout.!error.no_payment_info'] = "Sie müssen eine Zahlungsart auswählen, um fortzufahren.";
$lang['Checkout.index.description_invoice'] = "Rechnung # %1\$s"; // %1$s is the invoice number
...
$lang['Checkout.index.totals.subtotal'] = "Zwischensumme";
$lang['Checkout.index.totals.tax'] = "%1\$s (%2\$s%%):"; // %1$s is the tax name, %2$s is the tax percentage
$lang['Checkout.index.totals.total'] = "Gesamtbetrag fällig:";
$lang['Checkout.contact_info.field_first_name'] = "Vorname";
$lang['Checkout.contact_info.field_last_name'] = "Nachname";
$lang['Checkout.contact_info.field_address1'] = "Adresse 1";
$lang['Checkout.contact_info.field_address2'] = "Adresszusatz";
$lang['Checkout.contact_info.field_city'] = "Stadt";
...
$lang['Checkout.ach_info.field_type'] = "Art";
$lang['Checkout.ach_info.field_accountnum'] = "Account Nummer";
...
$lang['Checkout.complete.totals.subtotal'] = "Zwischensumme total:";
$lang['Checkout.complete.totals.tax'] = "%1\$s (%2\$s%%):"; // %1$s is the tax name, %2$s is the tax percentage
$lang['Checkout.complete.totals.total'] = "Summe fällig:";
$lang['Checkout.complete.totals.total_paid'] = "Ganz bezahlt:";
$lang['Checkout.index.totals.credit'] = "Guthaben:";
$lang['Checkout.index.totals.paid'] = "Bezahlt:";
$lang['Checkout.!error.not_client_owner'] = "Sie müssen als Kunde angemeldet sein, um fortzufahren.";
?>