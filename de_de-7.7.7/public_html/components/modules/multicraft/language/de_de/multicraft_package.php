...
$lang['MulticraftPackage.!error.meta[server_name].format'] = "Bitte geben Sie einen Namen für den Server ein.";
$lang['MulticraftPackage.!error.meta[players].format'] = "Bitte geben Sie die maximale Anzahl an Slots für diesen Minecraft-Server na.";
...
$lang['MulticraftPackage.!error.meta[default_level].format'] = "Bitte wählen Sie eine gültige Standardrolle.";
$lang['MulticraftPackage.!error.meta[autostart].format'] = "Ob der Server automatisch starten soll, muss auf 1 oder 0 gesetzt sein.";
$lang['MulticraftPackage.!error.meta[create_ftp].format'] = "Ob ein FTP-Konto erstellt werden soll, muss auf 1 oder 0 festgelegt werden.";
$lang['MulticraftPackage.!error.meta[server_visibility].format'] = "Bitte wählen Sie eine gültige Serversichtbarkeit.";
$lang['MulticraftPackage.package_fields.server_name'] = "Servername";
$lang['MulticraftPackage.package_fields.players'] = "Spieler Slots";
$lang['MulticraftPackage.package_fields.memory'] = "Server-Arbeitsspeicher";
$lang['MulticraftPackage.package_fields.tooltip.memory'] = "Legen Sie den Arbeitsspeicher in MB fest, oder lassen Sie das Feld leer, um den Standardbetrag zu verwenden.";
$lang['MulticraftPackage.package_fields.jarfile'] = "JAR-Datei";
...
$lang['MulticraftPackage.package_fields.default_level_0'] = "Kein Zugang";
$lang['MulticraftPackage.package_fields.default_level_10'] = "Gast";
$lang['MulticraftPackage.package_fields.default_level_20'] = "Benutzer";
...
$lang['MulticraftPackage.package_fields.server_visibility_1'] = "Standardmäßig Rolle";
$lang['MulticraftPackage.package_fields.server_visibility_2'] = "Benutzer mit nur Rollen";
?>