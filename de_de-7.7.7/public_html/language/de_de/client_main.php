...
$lang['ClientMain.!info.invoice_due_text'] = "Ihr Konto hat einen ausstehenden Betrag von %1\$s. Bitte machen Sie so bald wie möglich eine Zahlung."; // %1$s is the total amount due for this client
$lang['ClientMain.!info.invoice_due_other_currencies'] = "Sie haben auch einen ausstehenden Betrag in anderen Währungen.";
$lang['ClientMain.myinfo.setting_invoices'] = "Sie erhalten derzeit Rechnungen von %1\$s."; // %1$s is the clients invoice method (e.g. Email, Paper, etc.)
...
$lang['ClientMain.myinfo.setting_autodebit_cc_zero_days'] = "Wir berechnen Ihre %1\$s am Tag der Zahlung mit dem Betrag x%2\$s."; // %1$s is the type of credit card (e.g. "Visa"), %2$s is the last 4 of the credit card number
$lang['ClientMain.myinfo.setting_autodebit_ach_zero_days'] = "Ihr %1\$s Konto wird am Fälligkeitstag mit der Endung x%2\$s belastet."; // %1$s is the type of payment account to charge (e.g. "Checking"), %2$s is the last 4 of the account number
...
$lang['ClientMain.!tooltip.invoice_method_paper'] = "Wir werden Rechnungen an die von uns hinterlegte Adresse drucken und versenden.";
...
$lang['ClientMain.edit.two_factor_step3'] = "Bestätigen Sie Ihr Einmalpasswort und klicken Sie dann auf \"Meine Informationen aktualisieren\". Sie müssen bei der nächsten Anmeldung Ihr Einmalpasswort eingeben.";
...
$lang['ClientMain.!info.service_in_review'] = "Die folgenden Dienstleistungen werden von Mitarbeitern überprüft. Nach der Genehmigung werden sie aktiviert:";
...
$lang['ClientMain.edit.field_receive_email_marketing'] = "Ich möchte E-Mails über neue Produkte, Dienstleistungen und Angebote erhalten.";
