...
$lang['Transactions.!error.currency.length'] = "

Die Währung muss aus 3 Zeichen bestehen.
";
...
$lang['Transactions.!error.date.format'] = "
...
$lang['Transactions.!error.currency.missing'] = "

Bitte legen Sie eine Währung fest.
";
$lang['Transactions.!error.currency.mismatch'] = "

Die angegebene Währung stimmt nicht mit mindestens einer der zugeordneten Rechnungen überein.
";
$lang['Transactions.!error.amounts.overage'] = "

Ein oder mehrere Amount to Pay-Werte konnten nicht auf die angegebene Rechnung angewendet werden. Stellen Sie sicher, dass der zu zahlende Betrag den auf der Rechnung fälligen Betrag nicht überschreitet, dass die Rechnung offen ist und die Summe der zu zahlenden Beträge den Zahlungs- oder Kreditbetrag nicht übersteigt.
";
