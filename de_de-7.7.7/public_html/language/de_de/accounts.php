...
$lang['Accounts.!error.last_name.empty'] = "Geben Sie bitte einen Nachnamen an.";
$lang['Accounts.!error.state.length'] = "Staat Länge darf maximal 3 Zeichen lang sein.";
$lang['Accounts.!error.country.length'] = "Der Ländercode darf nicht länger als 3 Zeichen sein.";
$lang['Accounts.!error.state.country_exists'] = "Bitte wählen Sie das Land, die der ausgewählten Region entspricht.";
$lang['Accounts.!error.account.length'] = "Bitte geben Sie eine Kundennummer ein.";
$lang['Accounts.!error.routing.empty'] = "Bitte geben Sie eine Überprüfungszahl an.";
$lang['Accounts.!error.last4.empty_ach'] = "Bitte geben Sie Ihre letzten 4 Ziffern Ihres Kontos ein.";
...
$lang['Accounts.!error.expiration.valid'] = "Das Verfallsdatum ist bereits abgelaufen.";
...
$lang['Accounts.getAchTypes.checking'] = "Überprüfung";
$lang['Accounts.getAchTypes.savings'] = "Gespeicherte Daten";
...
$lang['Accounts.getCcTypes.disc'] = "Entdecken";
...
$lang['Accounts.getCcTypes.switch'] = "Wechseln";
