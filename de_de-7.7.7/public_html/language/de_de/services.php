...
$lang['Services.!error.date_renews.format'] = "Ungültiges Erneuerungsdatumformat";
$lang['Services.!error.date_last_renewed.format'] = "Ungültiges letztes erneuertes Datumsformat";
$lang['Services.!error.date_suspended.format'] = "Ungültiges suspendiertes Datumsformat";
$lang['Services.!error.date_canceled.format'] = "Ungültiges Datumsformat";
$lang['Services.!error.use_module.format'] = "Ungültiges Nutzungsmodulformat.";
...
$lang['Services.!error.fields[][encrypted].format'] = "Ein Servicefeld für die Verschlüsselung hat ein ungültiges Format.";
...
$lang['Services.!error.date_canceled.valid'] = "Sie müssen ein gültiges Datum festlegen, um diesen Dienst abzubrechen.";
$lang['Services.getActions.suspend'] = "Sperren";
$lang['Services.getActions.unsuspend'] = "Nicht suspendieren";
...
$lang['Services.getActions.change_renew'] = "Erneuerungsdatum ändern";
$lang['Services.!error.qty.available'] = "Mengenlimit erreicht. Wenn möglich, wählen Sie bitte eine kleinere Menge.";
$lang['Services.!error.client_id.allowed'] = "Der Kunde kann nicht auf dieses Paket zugreifen.";
...
$lang['Services.!error.prorate.format'] = "Ob anteilsmäßig festgelegt werden soll, muss auf 'true' oder 'false' gesetzt werden.";
