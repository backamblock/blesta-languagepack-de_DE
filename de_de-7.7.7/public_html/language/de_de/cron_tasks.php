...
$lang['CronTasks.!error.key.length'] = "Die Schlüssellänge für Cron-Aufgaben darf 64 Zeichen nicht überschreiten.";
...
$lang['CronTasks.crontask.description.cancel_scheduled_services'] = "Dienste, für die zukünftige Stornierungsdaten festgelegt wurden, werden im ausgewählten Intervall entfernt.";
...
$lang['CronTasks.crontask.name.exchange_rates'] = "Wechselkurs-Updates";
...
$lang['CronTasks.crontask.name.cleanup_logs'] = "Logs bereinigen";
$lang['CronTasks.crontask.name.process_renewing_services'] = "Bearbeiten Sie die Serviceverlängerungen";
$lang['CronTasks.crontask.description.process_renewing_services'] = "Das Erneuern von Diensten, die an Module angeschlossen sind, wird in dem ausgewählten Intervall erneuert.";
$lang['CronTasks.crontask.name.backups_amazons3'] = "Amazon S3 Backups";
$lang['CronTasks.crontask.description.backups_amazons3'] = "Amazon S3-Backups werden unter Systemeinstellungen > Backup > Amazon S3 geplant.";
...
$lang['CronTasks.!error.task_type.format'] = "Ungültiger Aufgabentyp. Muss ein Modul, ein Plugin oder ein System sein.";
