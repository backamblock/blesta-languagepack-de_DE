...
$lang['ClientServices.cancel.heading_cancel'] = "Service abbrechen";
...
$lang['ClientServices.cancel.confirm_cancel_now_fee'] = "Bei sofortiger Kündigung dieses Services wird eine Stornierungsgebühr von %1\$s erhoben."; // %1$s is the formatted amount of the cancelation fee
...
$lang['ClientServices.manage.button_in_review'] = "In Überprüfung";
...
$lang['ClientServices.manage.text_date_suspended'] = "Dieser Dienst wurde am %1\$s ausgesetzt."; // %1$s is the date the service was suspended
...
$lang['ClientServices.upgrade.btn_make_payment'] = "Eine Zahlung tätigen";
...
$lang['ClientServices.upgrade.text_prorate'] = "Wenn das von Ihnen gewählte neue Paket mehr kostet, wird die anteilige Differenz in Rechnung gestellt.";
...
$lang['ClientServices.!notice.queued_service_change'] = "Dieser Dienst hat ausstehende Änderungen. Zusätzliche Änderungen können nicht vorgenommen werden, bis die aktuellen ausstehenden Änderungen verarbeitet wurden.";
...
$lang['ClientServices.!success.service_queue'] = "Das Service-Update wurde in die Warteschlange gestellt und wird in Kürze verarbeitet.";
...
$lang['ClientServices.manageoptions.boxtitle_options'] = "Verwalten Sie die konfigurierbaren Optionen für %1\$s - %2\$s"; // %1$s is the package name, %2$s is the service name
...
$lang['ClientServices.review.heading_current_service'] = "Aktueller Service";
$lang['ClientServices.review.heading_updated_service'] = "Service aktualisiert";
...
$lang['ClientServices.review.boxtitle_review'] = "Änderungen an %1\$s - %2\$s überprüfen"; // %1$s is the package name, %2$s is the service name
